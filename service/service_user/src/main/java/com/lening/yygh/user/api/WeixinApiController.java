...
import com.lening.yygh.user.utils.ConstantWxPropertiesUtils;
...
public class WeixinApiController {
    ...
    public String callback(String code, String state) {
        ...
        return "redirect:" + ConstantWxPropertiesUtils.YYGH_BASE_URL +
                "/weixin/callback?token="+map.get("token")+"&openid="+map.get("openid")+"&name="+URLEncoder.encode(map.get("name"),"UTF-8");
