...
import com.lening.yygh.hosp.mapper.DepartmentRepository;
import com.lening.yygh.hosp.mapper.ScheduleMapper;
import com.lening.yygh.hosp.mapper.ScheduleRepository;
...
public class ScheduleServiceImpl extends ServiceImpl<ScheduleMapper,Schedule> implements ScheduleService {
    ...
    public Page<Schedule> selectPage(int page, int limit, ScheduleQueryVo scheduleQueryVo) {
        ...
        //去数据库查询需要的实体类，页面传递过来的是vo，所以我们需要把vo里面的属性值复制到实体类中
        //并且我们需要查询的是没有删除的，删除的是1，没有删除的是0
