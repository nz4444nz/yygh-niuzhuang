...
import com.lening.yygh.hosp.HospitalFeignClient;
import com.lening.yygh.model.order.OrderInfo;
import com.lening.yygh.model.user.Patient;
import com.lening.yygh.order.mapper.OrderInfoMapper;
...
//短信提示
            MsmVo msmVo = new MsmVo();
            msmVo.setPhone(orderInfo.getPatientPhone());
            msmVo.setTemplateCode("SMS_266645105");
    ...
    public Map<String, Object> getCountMap(OrderCountQueryVo orderCountQueryVo) {
        ...
        List<OrderCountVo> orderCountVoList
                = orderMapper.selectOrderCount(orderCountQueryVo);
        //日期列表
